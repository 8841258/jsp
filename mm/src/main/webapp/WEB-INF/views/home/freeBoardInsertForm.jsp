...
<div class="container-fluid  dashboard-content">
	<div class="row">
		...
		<!-- ============================================================== -->
		<div class="col-12">
			<form name="frm" action="freeBoardInsert.do" encType = "multipart/form-data" method="post">
				<div class="card">
					<h5 class="card-header">자유 게시판</h5>
					<div class="card-body">
						<div class="form-group">
							<input id="inputText3" name="freetitle" type="text"
								class="form-control" placeholder="제목">
						</div>
						<div class="form-group">
							<textarea class="form-control" id="exampleFormControlTextarea1"
								name="freecontent" rows="10" placeholder="여기에 내용을 입력하세요"></textarea>
						</div>
